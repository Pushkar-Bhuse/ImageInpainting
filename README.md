...
| :-------------------------: | :---------------------------: | 
| ![alt text](https://github.com/Pushkar-Bhuse/ImageInpainting/blob/[branch]/raw_image1.png?raw=true) | ![alt text (https://github.com/Pushkar-Bhuse/ImageInpainting/blob/[branch]/inpainted1.png?raw=true) | 
| ![alt text](https://github.com/Pushkar-Bhuse/ImageInpainting/blob/[branch]/raw_image2.png?raw=true) | ![alt text (https://github.com/Pushkar-Bhuse/ImageInpainting/blob/[branch]/inpainted2.png?raw=true) | 
